...
interface LiveMonitorGridProps {
    students: any[];
    accessCode: string;
    // Adăugăm CANCEL_ROBOT la tipuri
...
const styles = {
    gridContainer: { display: 'flex', flexDirection: 'column' as const, gap: '25px', width: '100%', padding: '20px 0', alignItems: 'stretch' },
    emptyContainer: { display: 'flex', flexDirection: 'column' as const, alignItems: 'center', justifyContent: 'center', padding: '60px', background: '#fff', borderRadius: '20px', border: '2px dashed #e2e8f0', marginTop: '20px' },
    emptyTitle: { color: '#1e293b', fontSize: '1.2rem', fontWeight: 800, marginBottom: '8px' },
    emptySub: { color: '#64748b', fontSize: '0.9rem' },
    pulseDot: { width: '12px', height: '12px', backgroundColor: '#10b981', borderRadius: '50%', marginBottom: '20px', boxShadow: '0 0 0 rgba(16, 185, 129, 0.4)', animation: 'pulse-green 2s infinite' }
};
